...
public class SmbUtil {
    ...
    @Value("${smb.username}")
    public static final String SMB_USERNAME = "kaisikaipu"; // SMB 协议用户名
    @Value("${smb.password}")
    public static final String SMB_PASSWORD = "chenkskp"; // SMB 协议用户密码
    ...
    public static void main(String[] args) {
        // 测试，展示远程共享目录下的文件里列表
        //SmbUtil.listFile(SMB_REMOTE_HOST, SMB_USERNAME, SMB_PASSWORD, SMB_SHARE_PATH, "202203");
